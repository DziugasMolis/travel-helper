...
public class TravelController {
    ...
    @GetMapping
    public ResponseEntity<Object> greeting(@Parameter(example = "100") @RequestParam Double length,
                                           @Parameter(example = "5") @RequestParam Integer travellers,
                                           @Parameter(example = "2021-12-31") @RequestParam(required = false, defaultValue = "#{T(java.time.LocalDate).now()}") LocalDate startDate) {
